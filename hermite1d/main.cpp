...
Real exact_solution(Point const p) { return std::sin(0.5 * M_PI * p(0)); }
...
public:
  ...
  virtual void init_data()
  {
    ...
    //        this->get_dof_map().add_dirichlet_boundary(DirichletBoundary({1},
    //        {0}, &one));
...
int main(int argc, char * argv[])
{
  ...
  //                 << t_step+1;
  //
  //       ExodusII_IO(mesh).write_timestep(file_name.str(), es, 1,
  //       system.time);
  //     }
  // }
